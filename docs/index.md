...
1. `PROJECT_STATUS.md` — 当前阶段、完成项、下一步
2. `00_MASTER_DESIGN.md` — 系统边界与总体设计
3. `06_KNOWLEDGE_SKILLS_ARCHITECTURE_AND_FEEDBACK_LOOP.md` — 知识、Skills、评测与反馈架构
4. `ARCHITECTURE.md`（仓库根目录）— 项目目录分工
...
| `07_REPOSITORY_OPERATING_MODEL.md` | APPROVED_FOR_SCAFFOLD | Codex 项目运行方式 |
