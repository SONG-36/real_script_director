...
- Codex-first repository scaffold
- Root and scoped `AGENTS.md`
- Design document index and project status
- Six repository skills
- Source, Digest, Knowledge, Eval and Feedback layers
- Optional VS Code/Copilot customization examples
